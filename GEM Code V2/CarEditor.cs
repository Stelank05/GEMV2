...
namespace GEM_Code_V2
{
    public partial class CarEditor : Form
    {
        ...
        {
            if (!CM.Valid(FilePath) || tb_CN.Text == null || tb_OVR.Text == null || tb_BOP.Text == null || tb_Reliability.Text == null || cb_Classes.SelectedIndex == -1)
            {
        ...
        private void btn_CreateCar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    CarList.Add(new Car(cb_Classes.SelectedItem.ToString(), tb_CN.Text, Convert.ToInt32(tb_OVR.Text), Convert.ToInt32(tb_BOP.Text), Convert.ToInt32(tb_Reliability.Text)));
                    LoadCars();
                }
            }
        }
